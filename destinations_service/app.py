...
api = Api(
    app,
    title="Destinations Microservice",
    version="1.0",
    description="Destinations Service API Documentation",
)
...
create_destination_model = api.model(
...
class DestinationResource(Resource):
    ...
    def delete(self, id):
        ...
        return {"Message": f"Destination deleted : {deleted_name} "}, 200
